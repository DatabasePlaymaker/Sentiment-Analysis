# -*- coding: utf-8 -*-
"""Analisis Sentimen - [NaïveBayes] - Ulasan MyPertamina - 2Label.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18XRDnZVVCK66Eu_X0YTA-9nmPFRX_FVs
...
more_stop_words = ["dengan", "tidak", "aku", "engkau", "kamu", "beliau", "kalian", "kita", "sini", "situ", "sana",
                   ...
                   "gak", "buat", "ke", "ga", "suka", "karena", "banget", "hal", "dalam", "amat", "sudah", "tapi", "lagi"]
...
df_values.to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_mypertamina_1.csv')
