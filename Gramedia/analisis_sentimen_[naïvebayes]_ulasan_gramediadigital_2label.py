# -*- coding: utf-8 -*-
"""Analisis Sentimen - [NaïveBayes] - Ulasan GramediaDigital - 2Label.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TOj701RiakLsnEL3JhcBgevR4QDvbJXa
...
df = pd.read_csv("/content/drive/MyDrive/Dataset Ulasan Google Play/scrapped_data_GramediaDigital_1.csv")
df.head()
...
more_stop_words = ["dengan", "tidak", "aku", "engkau", "kamu", "beliau", "kalian", "kita", "sini", "situ", "sana",
                   ...
                   "gak", "buat", "ke", "ga", "suka", "karena", "banget", "hal", "dalam", "amat", "sudah", "tapi", "lagi", "tq","disini"]
...
df['steamming'].to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_GramediaDigital_1.csv', index = False)

df_steamming = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_GramediaDigital_1.csv', encoding = 'latin1')
df_steamming
...
df_values.to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_GramediaDigital_1.csv')

# Load Dataset Hasil Translate

df_values = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_GramediaDigital_1.csv', index_col=0)
df_values
...
show_bar_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi GramediaDigital")
...
show_pie_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi GramediaDigital")
