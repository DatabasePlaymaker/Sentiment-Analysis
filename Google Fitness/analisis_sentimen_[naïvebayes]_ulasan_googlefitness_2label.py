# -*- coding: utf-8 -*-
"""Analisis Sentimen - [NaïveBayes] - Ulasan GoogleFitness - 2Label.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XPATMwdwWsP7-cd9OR4P3d0CFg3oWKKS
...
df = pd.read_csv("/content/drive/MyDrive/Dataset Ulasan Google Play/scrapped_data_GoogleFitness_1.csv")
df.head()
...
# df['steamming'].to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_GoogleFitness_1.csv', index = False)

df_steamming = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_GoogleFitness_1.csv', encoding = 'latin1')
df_steamming
...
# df_values.to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_GoogleFitness_1.csv')

# Load Dataset Hasil Translate

df_values = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_GoogleFitness_1.csv', index_col=0)
df_values
...
show_bar_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi GoogleFitness")
...
show_pie_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi GoogleFitness")
