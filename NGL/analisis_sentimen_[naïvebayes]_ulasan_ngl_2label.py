# -*- coding: utf-8 -*-
"""Analisis Sentimen - [NaïveBayes] - Ulasan NGL - 2Label.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AZQik1gbfHDEQmW5Y7WYpXzdHvJAIHiT
...
df = pd.read_csv("/content/drive/MyDrive/Dataset Ulasan Google Play/scrapped_data_NGL_1.csv")
df.head()
...
df['steamming'].to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_NGL_1.csv', index = False)
...
df_values = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_NGL_1.csv', index_col=0)
df_values
...
show_bar_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi NGL")
...
show_pie_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi NGL")
